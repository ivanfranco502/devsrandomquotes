...
class App extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      quote: props.quotes[0].quote,
      author: props.quotes[0].author };

    this.handleClick = this.handleClick.bind(this);
  }

  handleClick() {
    const randomIndex = Math.floor(Math.random() * 188);
    this.setState({
      quote: this.props.quotes[randomIndex].quote,
      author: this.props.quotes[randomIndex].author });
  ...
  render() {
    return (
      React.createElement("div", { class: "row d-flex justify-content-center align-items-center min-vh-100" },
      ...
      React.createElement("div", { id: "author", class: "float-right" },
      this.state.author))));
...
ReactDOM.render(React.createElement(App, { quotes: quotesForDev }), document.getElementById("root"));
